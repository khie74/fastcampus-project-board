...
-- 계정 정보를 먼저 생성해야 foreign key 제약이 없다.
-- TODO: 테스트용이지만 비밀번호가 노출된 데이터 세팅. 개선하는 것이 좋을지 고민이다.
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
('hgd', '12345', '홍길동', 'abc@gmail.com', 'I am 홍길동.', now(), '홍길동', now(), '홍길동'),
('hdi', '12345', '흰둥이', 'def@gmail.com', 'I am 흰둥이.', now(), '흰둥이', now(), '흰둥이'),
('mmi', '12345', '멍멍이', 'hij@gmail.com', 'I am 멍멍이.', now(), '멍멍이', now(), '멍멍이');
